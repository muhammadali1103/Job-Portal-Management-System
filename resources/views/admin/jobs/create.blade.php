        ...
        <div class="col-lg-8">
            ...
            <form action="{{ route('admin.jobs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5 text-center">
                    <h3 class="fw-bold text-dark mb-2">Create Job Posting</h3>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group contact-group">
                                        ...
                                        <input type="text" class="form-control ps-3 phone-number-input" name="primary_mobile"
                                            placeholder="Mobile Number" value="{{ old('primary_mobile') }}">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div
                                            ...
                                            <input class="form-check-input position-absolute top-50 start-50" type="radio"
                                                ...
                                                value="whatsapp" onchange="toggleApplyFields()" checked>
                                            <label
