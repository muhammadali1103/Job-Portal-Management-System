...
@section('header_title', 'Post a Job')
        ...
        <div class="col-lg-8">
            ...
            <form action="{{ route('user.jobs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5 text-center">
                    <h3 class="fw-bold text-dark mb-2">Create a Job Posting</h3>
                    <p class="text-muted">Fill in the details below to find your perfect candidate.</p>
                </div>
                ...
                <div class="mb-5">
                        ...
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="title" name="title" required
                                    value="{{ old('title') }}" placeholder="e.g. Senior Software Engineer">
                            </div>
                            ...
                            <div class="row g-4 mb-4">
                                ...
                                <div class="col-md-6">
                                    <label for="job_type"
                                        class="form-label text-muted small text-uppercase fw-bold ls-1">Job Type <span
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <label for="job_role"
                                        class="form-label text-muted small text-uppercase fw-bold ls-1">Job Role <span
                                            class="text-danger">*</span></label>
                                    <select id="job_role" name="job_role" required placeholder="Select or type to add...">
                                        <option value="">Select or type to add...</option>
                                        @foreach($jobRoles as $role)
                                            <option value="{{ $role }}" {{ old('job_role') == $role ? 'selected' : '' }}>
                                                {{ $role }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <label for="location_id"
                                        class="form-label text-muted small text-uppercase fw-bold ls-1">Location <span
                                            class="text-muted fw-normal text-capitalize ms-1">(Optional)</span></label>
                                    <select class="form-select" id="location_id" name="location_id">
                                        ...
                                        @foreach($locations as $location)
                                            @php
                                                ...
                                                $selected = old('location_id') == $location->id || (!old('location_id') && $isAllLocations);
                                            @endphp
                                            <option value="{{ $location->id }}" {{ $selected ? 'selected' : '' }}
                                                ...
                                                {{ $location->city }} {{ $isAllLocations ? '(Recommended)' : '' }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="nationality" name="nationality">
                                        ...
                                        <option value="European/Western">European/Western</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-4">
                                <div class="row g-4 mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="experience" name="experience"
                                            placeholder="e.g. 2 Years" value="{{ old('experience') }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="qualification" name="qualification"
                                        placeholder="e.g. Bachelor's Degree" value="{{ old('qualification') }}">
                                </div>

                                <div>
                                    <label for="description"
                                        class="form-label text-muted small text-uppercase fw-bold ls-1">Description <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="card border-0 shadow-sm rounded-4">
                            <div class="card-body p-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group contact-group">
                                            <select class="form-select country-code-select" name="primary_country_code">
                                                @include('partials.country-codes', ['selectedCode' => old('primary_country_code', '+1')])
                                            </select>
                                            <input type="text" class="form-control phone-number-input" name="primary_mobile"
                                                placeholder="Mobile" value="{{ old('primary_mobile') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label text-muted small text-uppercase fw-bold ls-1">Contact
                                            Email <span
                                                class="text-muted fw-normal text-capitalize ms-1">(Optional)</span></label>
                                        <input type="email" class="form-control" name="contact_email"
                                            value="{{ old('contact_email') }}" placeholder="company@email.com">
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div
                                                ...
                                                <input class="form-check-input position-absolute top-50 start-50"
                                                    type="radio" style="opacity: 0;" name="apply_method"
                                                    id="method_whatsapp" value="whatsapp" onchange="toggleApplyFields()"
                                                    checked>
                                                <label
                                                    ...
                                                    <small class="text-muted" style="font-size: 0.75rem;">Chat
                                                        directly</small>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div
                                                class="form-check custom-radio-card h-100 position-relative p-0 rounded-3 border overflow-hidden">
                                                <input class="form-check-input position-absolute top-50 start-50"
                                                    type="radio" style="opacity: 0;" name="apply_method" id="method_email"
                                                    value="email" onchange="toggleApplyFields()">
                                                <label
                                                    class="form-check-label d-flex flex-column align-items-center justify-content-center p-4 text-center h-100 w-100"
                                                    for="method_email">
                                                    ...
                                                    <small class="text-muted" style="font-size: 0.75rem;">Receive
                                                        CVs</small>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div
                                                class="form-check custom-radio-card h-100 position-relative p-0 rounded-3 border overflow-hidden">
                                                <input class="form-check-input position-absolute top-50 start-50"
                                                    type="radio" style="opacity: 0;" name="apply_method" id="method_website"
                                                    value="website" onchange="toggleApplyFields()">
                                                <label
                                                    class="form-check-label d-flex flex-column align-items-center justify-content-center p-4 text-center h-100 w-100"
                                                    for="method_website">
                                                    ...
                                                    <small class="text-muted" style="font-size: 0.75rem;">External
                                                        link</small>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div id="apply_fields_container" class="bg-light rounded-3 p-4 mt-3">
                                    <div id="whatsapp_group">
                                        ...
                                        <div class="input-group whatsapp-group">
                                            <select class="form-select border-white country-code-select" name="whatsapp_country_code">
                                                @include('partials.country-codes', ['selectedCode' => old('whatsapp_country_code', '+1')])
                                            </select>
                                    ...
                                    <div id="email_group" class="d-none">
                                    ...
                                    <div id="website_link_group" class="d-none">
                    ...
                    <div class="text-center mb-5">
                        <button type="submit"
                            class="btn btn-primary btn-lg px-5 py-3 rounded-pill fw-bold shadow-sm w-100 mb-3"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            new TomSelect("#job_role", {
                ...
                dropdownParent: 'body',
                items: ["{{ old('job_role') }}"], // Pre-select old value if exists
            });
        });
    </script>
@endsection
